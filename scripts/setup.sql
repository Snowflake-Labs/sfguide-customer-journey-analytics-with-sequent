/*
 * ===========================================================================
 * Snowpath™ - Complete Setup for Quickstarts, Demos & Hands-on Labs
 * ===========================================================================
 * 
 * Execution Time: ~15-20 minutes
 * 
 * Instructions:
 * 1. Open this file in Snowsight SQL Worksheet
 * 2. Adjust JOURNEY_COUNT below (100000 recommended)
 * 3. Select all and execute
 * 4. Wait for completion
 * 
 * After Setup:
 * - Warehouse: SNOWPATH_WH
 * - Database: SNOWPATH_DB
 * - Role: SNOWPATH_ROLE
 * - Main table: SNOWPATH_DB.RETAIL.RETAIL_EVENTS
 * 
 * ===========================================================================
 */
...
CREATE ROLE IF NOT EXISTS SNOWPATH_ROLE;
GRANT ROLE SNOWPATH_ROLE TO ROLE SYSADMIN;

-- Create warehouse
CREATE WAREHOUSE IF NOT EXISTS SNOWPATH_WH
  WITH 
...
GRANT USAGE ON WAREHOUSE SNOWPATH_WH TO ROLE SNOWPATH_ROLE;
GRANT OPERATE ON WAREHOUSE SNOWPATH_WH TO ROLE SNOWPATH_ROLE;

USE WAREHOUSE SNOWPATH_WH;

-- Create database and schemas
CREATE DATABASE IF NOT EXISTS SNOWPATH_DB;
GRANT ALL ON DATABASE SNOWPATH_DB TO ROLE SNOWPATH_ROLE;

CREATE SCHEMA IF NOT EXISTS SNOWPATH_DB.RETAIL;
CREATE SCHEMA IF NOT EXISTS SNOWPATH_DB.GAMING;
CREATE SCHEMA IF NOT EXISTS SNOWPATH_DB.HOSPITALITY;
CREATE SCHEMA IF NOT EXISTS SNOWPATH_DB.DELIVERY;
CREATE SCHEMA IF NOT EXISTS SNOWPATH_DB.FSI;
CREATE SCHEMA IF NOT EXISTS SNOWPATH_DB.ANALYTICS;

GRANT ALL ON ALL SCHEMAS IN DATABASE SNOWPATH_DB TO ROLE SNOWPATH_ROLE;

-- ===========================================================================
-- SECTION 2: PRIVILEGES
-- ===========================================================================

GRANT IMPORTED PRIVILEGES ON DATABASE SNOWFLAKE TO ROLE SNOWPATH_ROLE;

GRANT CREATE TABLE ON SCHEMA SNOWPATH_DB.RETAIL TO ROLE SNOWPATH_ROLE;
GRANT CREATE TABLE ON SCHEMA SNOWPATH_DB.GAMING TO ROLE SNOWPATH_ROLE;
GRANT CREATE TABLE ON SCHEMA SNOWPATH_DB.HOSPITALITY TO ROLE SNOWPATH_ROLE;
GRANT CREATE TABLE ON SCHEMA SNOWPATH_DB.DELIVERY TO ROLE SNOWPATH_ROLE;
GRANT CREATE TABLE ON SCHEMA SNOWPATH_DB.FSI TO ROLE SNOWPATH_ROLE;
GRANT CREATE TABLE ON SCHEMA SNOWPATH_DB.ANALYTICS TO ROLE SNOWPATH_ROLE;

GRANT CREATE VIEW ON SCHEMA SNOWPATH_DB.ANALYTICS TO ROLE SNOWPATH_ROLE;
GRANT CREATE STAGE ON SCHEMA SNOWPATH_DB.ANALYTICS TO ROLE SNOWPATH_ROLE;
GRANT CREATE STREAMLIT ON SCHEMA SNOWPATH_DB.ANALYTICS TO ROLE SNOWPATH_ROLE;

-- Future grants (critical for app functionality)
GRANT ALL ON FUTURE TABLES IN SCHEMA SNOWPATH_DB.RETAIL TO ROLE SNOWPATH_ROLE;
GRANT ALL ON FUTURE TABLES IN SCHEMA SNOWPATH_DB.GAMING TO ROLE SNOWPATH_ROLE;
GRANT ALL ON FUTURE TABLES IN SCHEMA SNOWPATH_DB.HOSPITALITY TO ROLE SNOWPATH_ROLE;
GRANT ALL ON FUTURE TABLES IN SCHEMA SNOWPATH_DB.DELIVERY TO ROLE SNOWPATH_ROLE;
GRANT ALL ON FUTURE TABLES IN SCHEMA SNOWPATH_DB.FSI TO ROLE SNOWPATH_ROLE;
GRANT ALL ON FUTURE TABLES IN SCHEMA SNOWPATH_DB.ANALYTICS TO ROLE SNOWPATH_ROLE;
GRANT ALL ON FUTURE VIEWS IN SCHEMA SNOWPATH_DB.ANALYTICS TO ROLE SNOWPATH_ROLE;

-- ===========================================================================
-- SECTION 3: RETAIL SYNTHETIC DATA FUNCTION (Example)
-- ===========================================================================

USE SCHEMA SNOWPATH_DB.RETAIL;
...
GRANT SELECT ON ALL TABLES IN SCHEMA SNOWPATH_DB.RETAIL TO ROLE SNOWPATH_ROLE;
...
GRANT SELECT ON ALL TABLES IN SCHEMA SNOWPATH_DB.FSI TO ROLE SNOWPATH_ROLE;

-- ===========================================================================
-- SECTION 6: GENERATE GAMING DATA
-- ===========================================================================

USE SCHEMA SNOWPATH_DB.GAMING;
...
GRANT SELECT ON ALL TABLES IN SCHEMA SNOWPATH_DB.GAMING TO ROLE SNOWPATH_ROLE;
...
USE SCHEMA SNOWPATH_DB.DELIVERY;
...
GRANT SELECT ON ALL TABLES IN SCHEMA SNOWPATH_DB.DELIVERY TO ROLE SNOWPATH_ROLE;

-- ===========================================================================
-- SECTION 8: GENERATE HOSPITALITY DATA
-- ===========================================================================

USE SCHEMA SNOWPATH_DB.HOSPITALITY;
...
GRANT SELECT ON ALL TABLES IN SCHEMA SNOWPATH_DB.HOSPITALITY TO ROLE SNOWPATH_ROLE;

-- ===========================================================================
-- SECTION 9: ATTRIBUTION STORED PROCEDURES
-- ===========================================================================

USE SCHEMA SNOWPATH_DB.ANALYTICS;
...
FROM SNOWPATH_DB.RETAIL.retail_events;
...
FROM SNOWPATH_DB.RETAIL.retail_events GROUP BY customer_id;
...
GRANT SELECT ON ALL VIEWS IN SCHEMA SNOWPATH_DB.ANALYTICS TO ROLE SNOWPATH_ROLE;

-- ===========================================================================
-- SECTION 11: STREAMLIT STAGE
-- ===========================================================================

CREATE STAGE IF NOT EXISTS STREAMLIT_STAGE DIRECTORY = (ENABLE = TRUE);
GRANT READ, WRITE ON STAGE SNOWPATH_DB.ANALYTICS.STREAMLIT_STAGE TO ROLE SNOWPATH_ROLE;

-- ===========================================================================
-- OPTIMIZE & COMPLETE
-- ===========================================================================

ALTER WAREHOUSE SNOWPATH_WH SET WAREHOUSE_SIZE = 'SMALL';

SELECT 'Snowpath™ Setup Complete - All Ready for Demos & Labs' AS STATUS;
